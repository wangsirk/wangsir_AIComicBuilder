...
Style: High-quality anime/animation character design sheet, studio-grade production art
Consistency: ALL four views must depict the EXACT same character with identical proportions, outfit, colors, and details
Proportions: Clean, accurate anatomy. Each view must be the same height — align feet and head across all four poses.
...
Quality: Sharp linework, professional coloring, no artifacts. This is the definitive reference that all future frames must match.`;
}
